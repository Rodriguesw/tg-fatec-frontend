...
export const ContainerModalCode = styled.div`
    width: auto;
    height: auto;
    padding: 16px;
...
export const ContainerButtonModalCode = styled.div`
    width: 100%;
    height: auto;
...
export const ContainerModalNewPassword = styled.div`
    width: 100%;
    height: auto;
    padding: 16px;
    max-width: 320px;
...
export const ContainerButtonModalNewPassword = styled.div`
       width: 100%;
    height: auto;
